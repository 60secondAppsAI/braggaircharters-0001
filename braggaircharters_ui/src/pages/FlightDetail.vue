						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="Number" type="text" placeholder="Enter Number" v-model="flightToAdd.number"></base-input>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Number</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Number" type="text" placeholder="Enter Number" v-model="flightDetails.number"></input>
																		</div>
						</td>
														</tr>
															<tr> 
